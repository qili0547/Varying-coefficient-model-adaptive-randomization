...
C=zeros(n,1)+5;
for i=1:n
  if ( Trt(i)==6) Z1(i)=1; else Z1(i)=0;end %
  if ( Trt(i)==1 ||Trt(i)==2  ||Trt(i)==3 ) C(i)=0; else C(i)=5;end %
  if ( Trt(i)==7) Z2(i)=1; else Z2(i)=0;end %
...
theta_n=6; %number treatment changing parameters
